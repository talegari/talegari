...
> Total YOE: `15 years`  
> Total DS YOE: `10 years and 3 months`  
...
- At [Games24x7](https://www.games24x7.com/): Led efforts in prescriptive(causal) and predictive models for acquisiton, retention and spend optimization for RummyCircle and My11circle. 
...
*July 2024 - Present | Bangalore | Team Size: 20*
  
  - **Leadership**:
  
    - Planning and delivery of data science projects in a fast-changing environment with quintessential stakeholder management.
    - Handling tight situations during high profile events such as IPL, World cups from both scaling datascience backends and people management perspective.
    - Managing people managers.
  
  - **Technical**:
  
    - Experimental designs such as geo-switchback experiments, diff-in-diff to measure campain effectiveness and estimate treatment effects.
    - Causal models such as uplift models to optimize offer and discount spends at end-customer level.
    - Market mix modeling and forecasts at acqusition channel level to optimize spends.
    - 'win-o-meter' during live matches based on player history, Estimating contest sizes and many more.
...
Prior work experince in Infosys as Mathematical Analyst, Teaching for IITJEE aspirants.
