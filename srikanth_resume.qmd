...
> Total YOE: `15 years and 3 months`  
> Total DS YOE: `11 years and 3 months`  
...
- At [Games24x7](https://www.games24x7.com/): Led efforts in prescriptive(causal), predictive models, gameplay simlulations and spend optimization for acquisiton, retention and spend optimization for [RummyCircle](https://www.rummycircle.com/) and [My11circle](https://www.my11circle.com/). (Domain: `RMG` -- Real money gaming).
...
- At [Dish](https://www.dish.com/): Setup AB testing framework for ideal customer offers and discounts, churn and CLV models for DISH Corporation/Sling Media. (Domain: telecommunications, entertainment)
- Implemented various Recommender Systems for News for [Newscase](https://www.newscase.com/) at Diet Code, Retail products for [Big Basket](https://www.bigbasket.com/) and Movie Recommendations for [Book My Show](https://in.bookmyshow.com/) at [Majorel](https://www.majorel.com/). (Domain: CRM)
- Avid open-source contributor: (Author / Maintainer) of [`tidypandas`](https://pypi.org/project/tidypandas/), [`tidypyspark`](https://pypi.org/project/tidypyspark/), [`tidier`](https://cran.r-project.org/package=tidier),
[`writer`](https://cran.r-project.org/package=writer),
[`solitude`](https://cran.r-project.org/package=solitude), [`tidyrules`](https://cran.r-project.org/package=tidyrules), [`disto`](https://cran.r-project.org/package=disto),
...
- Other things: 2nd place winner at Novartis [Datathon](https://godatathon.com/) 2024, Presented at conferences including Walmart AI summit 2023, PyData conf 2022.

> **Education**: [Masters in Applied Mathematics](http://mathstat.uohyd.ac.in/programmes-offered-school) (2010-14) from [University of Hyderabad](https://uohyd.ac.in/) (Central University of Hyderabad)
...
*July 2024 - Present | Bangalore | Team Size: 12*
  ...
  - **Technical**:
    ...
    - *Causal Inference and Experimentation*: Experimental designs such as geo-switchback experiments, diff-in-diff to measure campaign effectiveness, estimate treatment effects, uplift models to target appropriate audience.
    - *Game play simulation*: Computing ball-by-call to probable team score based on Bayesian updates with increasing information as the game progresses. This powers features such as live updation of `win-o-meter`, Probable rank and expected payout during the Cricket match.
    - *Estimation and Optimization*: Market mix modeling and forecasts at acquisition channel level to optimize spends over hierarchy of geography and event-nonevent periods.
